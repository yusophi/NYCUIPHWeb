...
<div class="Footer-container">
      <div class="footer-margin">
            <div class="footer-exclam">
                  <?php the_field('slogan', 2862);?>
            </div>
            <div class="footer-divider"></div>
            <div class="footer-pic"><img src="<?php bloginfo('template_url') ?>/images/icon/icon-footer-pic.svg"></div>
            <div class="footer-info">
                  <div id="footer-info-d2"><?php the_field('institution_info', 2862);?></div>
                  <div id="footer-info-d3"><?php the_field('connect_info', 2862);?></div>
            </div>
            <div class="footer-statement">
                  <div id="statement_block1">
                        ...
                        <?php $yt_link = get_field('youtube');
                              $fb_link = get_field('facebook'); ?> 
