var nav_disappearable = document.getElementById("nav-disappearable");
...
window.addEventListener("scroll", function () {
  nav_disappearable.classList.toggle("none-display", scrollY > 0);
  main_nav.classList.toggle("nav-menu-pullup", scrollY > 0);
  logo.classList.toggle("logo-stay", scrollY > 0);
});
