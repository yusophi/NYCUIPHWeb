...
for (var i = 0; i < nav_arrow.length; i++) {
  ...
  nav_arrow[i].addEventListener("click", function () {
    if (dropdown_menus[this.numParam].style.display == "none") {
        ...
        dropdown_menus[this.numParam].style.display = "inline-block";
...
var search_overlay_close_btn = document.getElementById(
    "search_overlay_closebtn"
);

var calendar_overlay = document.getElementById("calendar_overlay");
var calendar_overlay_close_btn = document.getElementById(
