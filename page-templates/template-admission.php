...
<div class="page_admission">
    ...
    <div class="scetion2">
        ...
        <div class="three_ad_icon">
            <a href="#!" class="ad_icon actived <?php if($locale == "en_US"){echo "en_ad_title";}?>"><?php echo $ad_MsPhD['ad_year']; ?></a>
            <a href="#!" class="ad_icon <?php if($locale == "en_US"){echo "en_ad_title";}?>"><?php echo $ad_PhD['ad_year']; ?></a>
            <a href="#!" class="ad_icon <?php if($locale == "en_US"){echo "en_ad_title";}?>"><?php echo $ad_Ms['ad_year']; ?></a>        
        </div>
