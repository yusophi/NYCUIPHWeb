...
<div class="homepage">
      ...
      <div class="events">
            ...
            <div id="event-slides">
                  <!--<img id="event-icon-prev" src="<?php //bloginfo('template_url') 
                                                      ?>/images/icon/icon-pre_white.svg">
                  <img id="event-icon-next" src="<?php //bloginfo('template_url') 
                                                      ?>/images/icon/icon-next_white.svg">-->
                  <div id="event-data">
                        <?php /*query the recent 6 posts*/
                        $args = array(
                              'post_type' => 'post',
            ...
            <div class="Aboutus-content-container">
                  <div class="intro_content">
                        <div class="intro_content-text">
                              ...
                              <!--<img class="icon_aboutus_1" src="<?php //bloginfo('template_url')
                                                                        ?>/images/icon/icon-aboutus-1.svg">
                                    -->
                        </div>
                  ...
                  <div class="videos">
                        <div class="module video1">
                              ...
                              <div class="bt-watchmore animation1_btn" onclick="on(1)">
                        ...
                        <div class="module video2">
                              ...
                              <div class="bt-watchmore animation1_btn" onclick="on(2)">
                                    <div class="watch_space"></div>
                                    <div class="watch_text">watch</div>
                                    <img class="watch_icon" src="<?php bloginfo('template_url') ?>/images/icon/icon-watch_blue.svg">
                                    <img class="watch_icon_hover" src="<?php bloginfo('template_url') ?>/images/icon/icon-watch_yellow.svg">
                              ...
                              <div class="profile">
                                    <div class="profile-header" onclick="currentProfile(<?php echo $counter; ?>)">
                                          <!--<?php //$imageQ = wp_get_attachment_image_src(get_field('staff_photo'), 'custom size'); 
                                                ?>-->
                                          <!--<img src="<?php //echo $imageQ[0]; 
                                                            ?>" alt="<? php // echo get_the_title(get_field('staff_photo')) 
                                                                        ?>" >-->
                                          ...
                                          <div class="overlay_profile_content">
                                                ...
                                                <div class="overlay_middle">
                                                      ...
                                                      <div class="overlay_self_info">
                                                            ...
                                                            <!--<p class="phone_num"><?php //the_field('phone_number') 
                                                                                          ?> </p>
                                                      <p class="email"><?php //the_field('email') 
                                                                        ?> </p>-->
      ...
      <link rel="stylesheet" href="<?php bloginfo('template_url') ?>/css/homepage.css">
      <link rel="stylesheet" href="<?php bloginfo('template_url') ?>/css/element-postSmall.css">
      <link rel="stylesheet" href="<?php bloginfo('template_url') ?>/css/events_card_style.css">
