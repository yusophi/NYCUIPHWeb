    ...
    <div class="course_outline">
        ...
        <div class="file_content ">
            ...
            <div class="links">
                ...
                <div class="file_link">
                    <a class="file_name" href="<?php echo esc_url($course_content['file1']);?>" target="_blank"><?php echo $course_content['file_name_1']; ?></a>
                ...
                <div class="file_link">
                    <a class="file_name" href="<?php echo esc_url($course_content['file2']);?>" target="_blank"><?php echo $course_content['file_name_2']; ?></a>
                ...
                <div class="file_link">
                    <a class="file_name" href="<?php echo esc_url($course_content['file3']);?>" target="_blank"><?php echo $course_content['file_name_3']; ?></a>
                ...
                <div class="file_link">
                    <a class="file_name" href="<?php echo esc_url($course_content['file4']);?>" target="_blank"><?php echo $course_content['file_name_4']; ?></a>
